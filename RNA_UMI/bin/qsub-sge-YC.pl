...
while (@Shell) {
    ...
    my $job_cmd = "pkubatch -J XHL_RNA_UMI -A tangfuchou_g1 -p cn-long --qos tangfuchoucnl -N1 -n1 -c1 ";  ## -l h_vmem=16G,s_core=8 
    #my $job_cmd = "pkubatch -J XHL_MethGC -A tangfuchou_g1 -p fat4way --qos tangfuchouf4w -N1 -n1 -c1 ";  ## -l h_vmem=16G,s_core=8 
