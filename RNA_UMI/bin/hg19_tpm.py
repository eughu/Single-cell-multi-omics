...
with open('/date/dongji/software/Anaconda/lib/python2.7/site-packages/RNA_UMI/bin/hg19_genelist/genelist.xls','r') as list:
    for s in list:
        s=s.strip()
        if s in gene_count:
...
with open('/date/dongji/software/Anaconda/lib/python2.7/site-packages/RNA_UMI/bin/hg19_genelist/list_gene_ercc.xls','r') as list:
    for s in list:
        s=s.strip()
