...
with open('/datf/xiehaoling/.pyenv/versions/anaconda2-5.3.1/lib/python2.7/RNA_UMI/bin/mm10_genelist/genelist.xls','r') as list:
    for s in list:
        s=s.strip()
        if s in gene_count:
...
with open('/datf/xiehaoling/.pyenv/versions/anaconda2-5.3.1/lib/python2.7/RNA_UMI/bin/mm10_genelist/list_gene_ercc.xls','r') as list:
    for s in list:
        s=s.strip()
