...
#        my_job.running_multi(cpu=8, is_debug = self.is_debug)
        my_job.running_SGE(vf="1G", maxjob=100, is_debug = self.is_debug)#3G
...
#        my_job.running_multi(cpu=10, is_debug = self.is_debug)
        my_job.running_SGE(vf="1G", maxjob=100, is_debug = self.is_debug)#2G
    ...
    def s02_Tophat(self):
        ...
        my_job = m_jobs.run_jobs(sh_file, sh_work_file, l_sh_info, l_sh_work)
#        my_job.running_multi(cpu=8, is_debug = self.is_debug)
        my_job.running_SGE(vf="7G,p=5",maxjob=100, is_debug = self.is_debug)
    ...
    def s03_HTSeq_known(self):
        ...
        my_job = m_jobs.run_jobs(sh_file, sh_work_file, l_sh_info, l_sh_work)
#        my_job.running_multi(cpu=10, is_debug = self.is_debug)
        my_job.running_SGE(vf="3G,p=6", maxjob=100, is_debug = self.is_debug)
