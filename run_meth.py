...
Example:
    python %s --ref hg19 --cutSites GCA.GCC.GCT,ACG.TCG --depth 1 samp_test.xls
...
#    part0.check_files(l_cut_sites)
    ...
    part1 = m01.MapFromRaw(ref, sam_Info, depth, l_cut_sites, is_debug = 0)
    part1.s01_Trim()
    part1.s02_Bismark()
    part1.s03_Bam2SingleC()
    part1.s04_lambdaMeth()
    part1.s05_statMeth()
    part1.s08_NDR_IGV()
    part1.s06_NDR()
    part1.s07_NUC()
    part1.s09_mergeNUC_NDR_rm()
    part1.s12_NDR_flanking()
    part1.s13_NDR_motif()
